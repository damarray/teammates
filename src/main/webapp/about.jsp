        ...
        <div style="margin: 0 auto; padding: 0 52px 15px;">
            ...
            <ul>
                <li style="margin: 0 0 10px 0;">
                    <a href="http://www.comp.nus.edu.sg/" target="_blank">School of Computing, National University of Singapore (NUS)<img src="images/externalLink.png" width="10px"></a>, for providing us with the infrastructure support to run the project.
                </li>
                <li style="margin: 0 0 10px 0;">
                    <a href="http://www.cdtl.nus.edu.sg/" target="_blank">Centre for Development of Teaching and Learning (CDTL)<img src="images/externalLink.png" width="10px"></a> of NUS, for supporting us with several Teaching Enhancement Grants over the years.
                </li>
                <li style="margin: 0 0 10px 0;">
                ...
                <li style="margin: 0 0 10px 0;">
                    <span class="bold">YourKit LLC</span>, for providing us with free licenses for the <a href="https://www.yourkit.com/.net/profiler/index.jsp" target="_blank">YourKit Java Profiler<img src="images/externalLink.png" width="10px"></a>
        ...
        <table>
            <tr>
                ...
                <td class="coreTeamDetailsCell">
                    <a href="http://www.comp.nus.edu.sg/~damithch" target="_blank">Damith C. Rajapakse<img src="images/externalLink.png" width="10px"></a><br><br>
                    Founder (2010)<br>
                    Project Mentor (2010 -)
                </td>
            </tr>
